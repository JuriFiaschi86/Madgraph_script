...
c         stop 21
c         rscale = 0
c         HT = sqrt(m_{\chi\chi}^2 + pT_j^2) + pT_j
          rscale=0d0
          
c          write (*,*)'Mass of particle 1: ',dsqrt(dot(P(0,1),P(0,1)))
c          write (*,*)'Mass of particle 2: ',dsqrt(dot(P(0,2),P(0,2)))
c          write (*,*)'Mass of particle 3: ',dsqrt(dot(P(0,3),P(0,3)))
c          write (*,*)'Mass of particle 4: ',dsqrt(dot(P(0,4),P(0,4)))
c          write (*,*)'Mass of particle 5: ',dsqrt(dot(P(0,5),P(0,5)))
          
c         mass of the particle 3
          rscale = dsqrt(dot(P(0,3),P(0,3)))
          
c          write (*,*)'Renormalization scale scale: ',rscale
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c          write (*,*)'Factorization scale: ',q2factorization(1)
